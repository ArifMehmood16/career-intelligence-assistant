...
_ASSESS_SYSTEM = (
    ...
    "A location, email, phone number, profile headline, job title line or "
    "employer-and-dates heading alone is never met or partial. Cite a passage "
    "that shows the work, skill or qualification itself.\n"
